package cn.edu.sjtu.omnilab.tpca.pattern.main;
...
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.*;
...
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.DBSCAN;
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.PatternSetDistance;
...
/**
 * java MainSequentialPatternMining -i <inputfolder> -o <outputfolder>
 * 
 * @author chenxm
 *
 */
public class gwjtest {
	//************ SETTINGS START **************
	...
	private static String DEFAULT_USER_FOLDER = "I:/LocationPrediction/MarkovPredictionTest/Dartmouth_WithoutPP/Data/PLD_test_1000/";
			//"I:/eclipse_workspace/temporalsequentialpatternmining/test/";
			//"I:/LocationPrediction/MarkovPredictionTest/Dartmouth_WithoutPP/Data/PartitionedLocationData/";
	private static String DEFAULT_PATTERN_OUT_FOLDER = "C:/Users/gwj/Desktop/patterns/";
	//************* SETTINGS END ***************
