...
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.Dataset;
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.DistanceMeasure;
import cn.edu.sjtu.omnilab.tpca.pattern.clustering.Instance;
...
/**
 * java SequentialPatternMining -i <inputfolder> -o <outputfolder>
 * 
 * @author chenxm
 *
 */
public class SequentialPatternMining {
	...
	private static String DEFAULT_USER_FOLDER = "src/main/resources/location/";
	private static String DEFAULT_PATTERN_OUT_FOLDER = "output/patterns";
